...
CREATE TABLE `p_access_logs`  (
  ...
  `system_info` varchar(64) CHARACTER SET utf8mb3  NULL DEFAULT NULL COMMENT '系统信息',
  `system_group` varchar(64) CHARACTER SET utf8mb3  NULL DEFAULT NULL COMMENT '系统家族',
  `system_type` varchar(64) CHARACTER SET utf8mb3  NULL DEFAULT NULL COMMENT '系统类型',
  `browser_version` varchar(64) CHARACTER SET utf8mb3  NULL DEFAULT NULL COMMENT '浏览器版本',
  `browser_name` varchar(64) CHARACTER SET utf8mb3  NULL DEFAULT NULL COMMENT '浏览器名称',
  `browser_group` varchar(64) CHARACTER SET utf8mb3  NULL DEFAULT NULL COMMENT '浏览器家族',
  `ip` varchar(64) CHARACTER SET utf8mb3  NULL DEFAULT NULL COMMENT 'ip',
  `date` datetime NULL DEFAULT NULL COMMENT '时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb3  ROW_FORMAT = DYNAMIC;
...
INSERT INTO `p_role_menu` VALUES (2, 'b771ec3e55c242829f255778ad483cbe');
INSERT INTO `p_role_menu` VALUES (2, '69678f29f8ef485194ca4c8dfdb8d033');
...
INSERT INTO `p_role_menu` VALUES (1, '69678f29f8ef485194ca4c8dfdb8d033');
