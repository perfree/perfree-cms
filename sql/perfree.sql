...
) ENGINE = InnoDB AUTO_INCREMENT = 271407 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `p_menu`  (
  ...
  `isCache` int NULL DEFAULT 0 COMMENT '是否缓存（0缓存 1不缓存）',
  `menuType` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '' COMMENT '菜单类型（M目录 C菜单 F按钮）',
...
-- Records of p_menu
-- ----------------------------
INSERT INTO `p_menu` VALUES ('1', '-1', '系统管理', '/system', 'system', 1, 1, 0, 0, '2023-12-08 08:50:22', '2023-12-08 08:50:24', NULL, NULL, 1, 0, '', '0', NULL, NULL, NULL);
INSERT INTO `p_menu` VALUES ('2', '1', '用户管理', 'user', '', 2, 1, 0, 0, '2023-12-08 08:55:06', '2023-12-08 08:55:09', 'system/user/index', NULL, 1, 0, '', '0', NULL, NULL, NULL);
INSERT INTO `p_menu` VALUES ('3', '1', '菜单管理', 'menu', '', 3, 1, 0, 0, '2023-12-08 08:55:06', '2023-12-08 08:55:09', 'system/menu/index', NULL, 1, 0, '', '0', NULL, NULL, NULL);
...
CREATE TABLE `p_photos`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键',
  `name` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '相册名',
  `desc` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '描述',
  `coverUrl` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '封面url',
